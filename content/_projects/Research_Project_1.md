...
subtitle: TÜBİTAK 3501 — Blockchain-backed secure edge access
description: A TÜBİTAK 3501-supported project developing a scalable authentication framework that uses blockchain and cryptographic accumulators to share authentication data securely across distributed edge nodes.
order: 1
active: true
card_image: null
...
- Scalable edge authentication for IoT environments
