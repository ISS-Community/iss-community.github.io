...
<div class="project-details">
  ...
  <div class="alert alert-info border-primary mb-4 p-3" style="border-left: 4px solid #2563eb; background: #f0f7ff;">
    ...
    <strong>Funding / Collaboration:</strong> This defense-industry supported project is led by industry partner BTS Group in collaboration with the Intelligent Systems Security Lab (ISSLab) at Eskişehir Osmangazi University, Recep Tayyip Erdogan University, and Milli Savunma University.<br>
